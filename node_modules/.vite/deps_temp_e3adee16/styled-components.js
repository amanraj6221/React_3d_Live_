...
function ze(e, t2, n2, o, s = []) {
  ...
  if (ie(e))
    return s.push(`.${e.styledComponentId}`), s;
  if (ke(e))
    return n2 ? (e.inject(n2, o), s.push(e.getName(o))) : s.push(e), s;
  if (Me(e))
    return Ge(e), s;
  if (le(e)) {
    const t3 = Fe(e);
...
function Ye(e) {
  ...
  for (let c2 = 0; c2 < t2; c2++) {
    ...
    if (0 !== r2 || i2 || l2 !== qe || 42 !== e.charCodeAt(c2 + 1))
      if (i2)
        42 === l2 && e.charCodeAt(c2 + 1) === qe && (i2 = false, c2++);
        ...
        if (0 === r2)
          if (123 === l2)
            ...
            59 === l2 && 0 === s && (n2 += e.substring(o, c2 + 1), o = c2 + 1);
      } else
...
function Je({ options: e = $, plugins: t2 = I } = $) {
    ...
    const d3 = function(e2) {
      ...
      for (; i4 < o; ) {
        ...
        if (34 !== t5 && 39 !== t5 || He(e2, i4))
          if (0 === a4)
            if (t5 === qe && i4 + 1 < o && 42 === e2.charCodeAt(i4 + 1)) {
              for (i4 += 2; i4 + 1 < o && (42 !== e2.charCodeAt(i4) || e2.charCodeAt(i4 + 1) !== qe); )
                i4++;
              i4 += 2;
            } else if (40 !== t5)
              if (41 !== t5)
                if (c3 > 0)
                  i4++;
                else if (42 === t5 && i4 + 1 < o && e2.charCodeAt(i4 + 1) === qe)
  ...
  for (let e2 = 0; e2 < t2.length; e2++)
    t2[e2].name || v(15), h2 = G(h2, t2[e2].name);
...
function ut(o, s, r2) {
        ...
        if (null !== n2 && n2[1] === m3 && n2[2] === p3.styleSheet && n2[3] === p3.stylis && n2[7] === a3 && function(e2, t2, n3) {
          ...
          y3 = function(e2, t2, n4) {
            ...
            for (let n5 = 0; n5 < e2.length; n5++) {
              ...
              for (const e3 in i4)
                "className" === e3 ? o4.className = ae(o4.className, i4[e3]) : "style" === e3 ? o4.style = Object.assign(Object.assign({}, o4.style), i4[e3]) : e3 in t2 && void 0 === t2[e3] || (o4[e3] = i4[e3]);
            }
  ...
  } }), _(d2, h2), g2.warnTooManyClasses = ((e, t2) => {
    let n2 = {}, o2 = false;
    return (s2) => {
